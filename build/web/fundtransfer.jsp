  ...
  background-color: #06b;
    ...
    <center>
      ...
      <div class="input-container ic1">
          <input id="firstname" class="input" type="text" name="acc_name" placeholder=" " required="" />
        <div class="cut"></div>
        <label for="firstname" class="placeholder">Account name</label>
      </div>
      <div class="input-container ic2">
          <input id="lastname" class="input" type="number" name="acc_no" placeholder=" " required=""/>
        <div class="cut"></div>
        <label for="lastname" class="placeholder">Account Number</label>
      </div>
      <div class="input-container ic2">
          <input id="email" class="input" type="text" name="acc_ifsc" placeholder=" " required=""/>
        <div class="cut cut-short"></div>
        <label for="email" class="placeholder">IFSC</>
      </div>
       <div class="input-container ic2">
           <input id="email" class="input" type="number" name="amt"  placeholder=" " required="" />
        <div class="cut cut-short"></div>
